...
Java_com_demo_opencv_MainActivity_getKern(JNIEnv *env, jobject thiz, jobject bitmap, jfloatArray var) {
    ...
    jfloat* jfloat = env->GetFloatArrayElements(var,NULL);

//    Mat kern = Mat_<float>(5, 5);
//    for (int i = 0; i < 25; i++) {
//        kern.at<float>(i) = jfloat[i];
//    }
    Mat kern5 = (Mat_<float>(5, 5) <<
            jfloat[0], jfloat[1], jfloat[2], jfloat[3], jfloat[4],
            jfloat[5], jfloat[6], jfloat[7], jfloat[8], jfloat[9],
            jfloat[10], jfloat[11], jfloat[12], jfloat[13], jfloat[14],
            jfloat[15], jfloat[16], jfloat[17], jfloat[18], jfloat[19],
            jfloat[20], jfloat[21], jfloat[22], jfloat[23], jfloat[24] );
//    Mat kern3 = (Mat_<float>(3, 3) <<
//            jfloat[6], jfloat[7], jfloat[8],
//            jfloat[11], jfloat[12], jfloat[13],
//            jfloat[16], jfloat[17], jfloat[18] );
//    Mat kern3 = (Mat_<float>(3, 3) <<
//            -1, 0, 1,
//            -2, 0, 2,
//            -1, 0, 1 );
...
//            0, 0, -1);
    ...
    filter2D(temp, temp,-1, kern5,Point(-1,-1));
